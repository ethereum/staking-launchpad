    ...
    <PageTemplate title="">
      <ValidatorClientPageStyles>
        ...
        <Text className="mt10">
          ...
          designed to perform well on embedded systems and personal mobile
          devices, including older smartphones with resource-restricted
          hardware. The Nimbus team are from{' '}
