...
export const INFURA_BEACON_URL          = `https://eth2-beacon-${IS_MAINNET ? "mainnet" : TESTNET_LAUNCHPAD_NAME.toLowerCase()}.infura.io/eth/v1/beacon/states/head/validator_balances`;
